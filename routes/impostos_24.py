...
# Define o blueprint
impostos_24_blueprint = Blueprint('impostos_24', __name__, template_folder='../templates', url_prefix='/impostos')

@impostos_24_blueprint.route('/', methods=['GET', 'POST'], strict_slashes=False)
...
def process_excel_faturamento(uploaded_file, mes, ano):
    ...
    # Tratamento do Dados de Faturamento
        ...
        tratamento_impostos['FUNTTEL'] = tratamento_impostos['CONTA'].apply(lambda x: x == 'NF SCM' or x == 'NF MENSALIDADE' or 
                                                                    x == 'DISPONIBILIDADE'or x == 'SERVIÇOS COMPLEMENTARES' 
                                                                    or x == 'SERVIÇOS DIGITAIS' or x == 'SVA SOBRE MVNO')
